...
1) В ходе проектой работы был разработан дизайн Multisite fabric со связности между клиентскими приложениями, организованной при помощи EVPN type-5 маршрутов
2) Собраны различные схемы резервирования и протестированы различные сценарии отказа